const RELEASE_BASE = "https://github.com/ronael/Reqraft/releases/download/v0.6.2";

export const DOWNLOAD_TARGETS = {
  macos: {
    label: "Download for macOS",
    detail: "Apple silicon \u00b7 Beta",
    href: `${RELEASE_BASE}/Reqraft-0.6.2-mac-arm64.dmg`,
  ...
  windows: {
    ...
    href: `${RELEASE_BASE}/Reqraft-0.6.2-win-x64-experimental.exe`,
  ...
  linux: {
    ...
    href: `${RELEASE_BASE}/Reqraft-0.6.2-linux-x86_64-experimental.AppImage`,
