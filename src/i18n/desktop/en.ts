...
export const DESKTOP_EN = {
  ...
  "capsule.editedVerdict": "edited · review",
  "capsule.sourceEditedVerdict": "source edited · rerun",
  "capsule.sourceEditedDetail": "the result was generated from the previous source text",
  "capsule.editedDetail": "checks applied to the original response",
  "capsule.informativeSignals": "informative signals",
  "capsule.checkResult": "check that the result preserves your intent",
  "capsule.level": "level",
  "capsule.error": "Error",
  ...
  "capsule.noInvention": "no issues found by local checks",
  ...
  "settings.preferences.generationGroup": "Generation",
  ...
  "popover.promptLabel": "Starting prompt — editable before running again",
  "popover.receiving": "Receiving…",
  "popover.lastResult": "Last result",
  "popover.resultLabel": "Result — editable before copying",
  "popover.resultEmpty": "The result is empty: write something before copying it.",
  "popover.copy": "copy",
  ...
  "settings.fidelityDetail": "How far a rewrite may move away from what you wrote.",
  "settings.fidelityStrict": "Strict - keep the wording",
  "settings.fidelityBalanced": "Balanced - recommended",
  "settings.fidelityPermissive": "Permissive - rewrite freely",
  "settings.outputLanguage": "Output language",
  "settings.outputLanguageDetail": "The language generated prompts are written in.",
  "settings.outputLanguageAuto": "Follow the input",
  "settings.outputLanguageCustom": "Choose a language",
  "settings.outputLanguageCustomLabel": "Output language to use",
  "settings.outputLanguagePlaceholder": "en-US",
  "settings.outputLanguageInvalid": "Enter a language, for example English or en-US.",
  "settings.timeout": "Response timeout",
  "settings.timeoutDetail": "How long a provider may take before the run is abandoned.",
  "settings.timeoutUnit": "seconds",
  "settings.timeoutInvalid": "Enter a duration in seconds greater than 0.",
  "settings.maxOutputTokens": "Maximum output tokens",
  "settings.maxOutputTokensDetail": "Leave empty to let the provider decide.",
  "settings.maxOutputTokensAuto": "Automatic",
  "settings.maxOutputTokensInvalid": "Enter a whole number greater than 0, or leave empty.",
