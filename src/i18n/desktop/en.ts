...
export const DESKTOP_EN = {
  ...
  "onboarding.tour.capture.title": "Rewrite without leaving what you are doing",
  "onboarding.tour.capture.body":
    "Select text in any app, use the shortcut and get a clearer version in seconds.",
  "onboarding.tour.capture.selection": "selection in Notes",
