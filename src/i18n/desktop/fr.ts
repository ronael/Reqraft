...
export const DESKTOP_FR = {
  ...
  "onboarding.tour.capture.title": "Reformulez sans quitter ce que vous faites",
  "onboarding.tour.capture.body":
    "Sélectionnez un texte dans n'importe quelle app, utilisez le raccourci et récupérez une version plus claire en quelques secondes.",
  "onboarding.tour.capture.selection": "sélection dans Notes",
