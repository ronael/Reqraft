export const BASE_RULES = [
  ...
  "Lorsqu'une information manque, conserve l'ambiguïté ou demande à l'agent de vérifier l'existant au lieu d'inventer la réponse.",
  "Une demande courte doit produire une reformulation courte, proportionnelle à la longueur et à la complexité de l'entrée.",
