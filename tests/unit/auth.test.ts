...
describe("TUI provider errors", () => {
  it("turns raw authentication errors into an actionable message", () => {
  ...
  it("does not expose raw provider response bodies for other HTTP errors", () => {
    const error = new Error(
      'Provider error 400: {"error":{"message":"Unsupported parameter: secret-detail"}}',
    );
    const message = formatUiError(error, "openai");
